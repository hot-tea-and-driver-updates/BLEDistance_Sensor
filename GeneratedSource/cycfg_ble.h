...
#define CY_BLE_GATT_DB_MAX_VALUE_LEN                (0x000Du)
#define CY_BLE_GATT_DB_INDEX_COUNT                  (0x0009u)
...
#define CY_BLE_GATT_DB_ATT_VAL_COUNT                (0x10u)

/** The size of the cy_ble_attValuesLen array */
#define CY_BLE_GATT_DB_ATT_VAL_LEN_COUNT            (0x04u)

/** GATT Role */
#define CY_BLE_GATT_ROLE                            (0x01u)
#define CY_BLE_GATT_DB_CCCD_COUNT                   (0x00u)
#define CY_BLE_ATT_UUID_128_COUNT                   (0x01u)
